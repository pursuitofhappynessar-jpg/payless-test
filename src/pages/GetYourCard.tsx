...
+      newErrors.governorate = 'Please select your governorate';
+    }
+
+    setErrors(newErrors);
...
+      const subject = encodeURIComponent('New Payless Card Application');
...
+              Thank you for choosing Payless! We've received your application and will contact you within 24 hours to activate your discount card.
+            </p>
+            
