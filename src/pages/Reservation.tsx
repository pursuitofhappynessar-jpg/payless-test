...
+      const subject = encodeURIComponent('New Payless Reservation Request');
+      const body = encodeURIComponent(`
+New Payless Reservation Request:
+
...
+
+Reservation submitted on: ${new Date().toLocaleString()}
+      `);
+      
+      const mailtoLink = `mailto:body.hamed@outlook.com?subject=${subject}&body=${body}`;
...
+              Thank you for using Payless! We've received your reservation request and will contact you within 24 hours to confirm the details and provide booking information.
+            </p>
+            
...
+                <div className="flex items-center space-x-2">
+                  <div className="w-2 h-2 bg-sky-500 rounded-full"></div>
+                  <span>Our team will process your reservation request</span>
+                </div>
+                <div className="flex items-center space-x-2">
+                  <div className="w-2 h-2 bg-sky-500 rounded-full"></div>
+                  <span>You'll receive confirmation with your discounted rates</span>
+                </div>
+              </div>
+            </div>
+            
...
+                    <p className="text-sm text-gray-600">Your Payless card ensures the best rates</p>
+                  </div>
+                </div>
+                
+                <div className="flex items-start space-x-3">
...
+                    <p className="text-sm text-gray-600">Reservations confirmed within 24 hours</p>
+                  </div>
+                </div>
+                
+                <div className="flex items-start space-x-3">
...
+                    <p className="text-sm text-gray-600">Priority booking and special perks</p>
+                  </div>
+                </div>
+              </div>
+              
...
+                  Exclusive access for Payless cardholders
+                </p>
+              </div>
+            </div>
+          </div>
...
+                        }`}
+                        placeholder="Enter your Payless card number"
+                      />
+                      {errors.idSerial && (
